...
target_project_id = "Insert_Your_Project_ID"
google_bard_api_key = "Insert_Your_Bard_API_Key"

# Initialize the Google Cloud Natural Language API client
language_client = language_v1.LanguageServiceClient.from_service_account_file(
